...
dop.core.error = {
    ...
    api: {
        ...
        ONSUBSCRIBE_NOFUNCTION: 'dop.onsubscribe only accept a function as parameter',
        ONSUBSCRIBE_NOOBJECT_RESOLVED: 'dop.onsubscribe callback must return or resolve a regular object'
    },
